...
public class VillagerPanel : UIPanel
{
    ...
    public override void Initialize()
    {
        ...
        EventManager.Instance.AddListener<VillagerEvents.AllVillagersInitializedEvent>(OnAllVillagersInitialized);
    }
    ...
    public void RefreshVillagerList()
    {
        ...
        List<Villager> villagers = VillagerManager.Instance.GetVillagers();

        // Update total count
        if (totalVillagersText != null)
        {
            totalVillagersText.text = $"Total Villagers: {villagers.Count}";
        }
    ...
    private void OnAllVillagersInitialized(VillagerEvents.AllVillagersInitializedEvent evt)
    {
        RefreshVillagerList();
    }
